...
\todo[inline]{expand:tribler tunnel community?}
\begin{table}[tbp]
	\centering
...
\todo[inline]{repost of problem description?}

\subsection{P2P currency and incentive}
Current currency used in Tribler (Multichain)\cite{2015:multichain:norberhuis}.\\ 
Torcoin \cite{2014:torcoin:ghosh}. \\
Lira \cite{2013:lira:jansen}.\\
Wealth/credit, resale value \cite{2012:economicbt:kash}.\\

Incentives. p2p net with wireless peer \cite{2015:incentivep2pgame:kang}.\\
Effort based incentive \cite{2010:effortincentive:rahman}.\\
...
\subsection{Prospecting and Investment}
