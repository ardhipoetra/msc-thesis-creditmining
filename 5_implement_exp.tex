...
%	\item mihai 136 12 hour. runs first.
%	\item cm 133. 12 hour. runs second.
...
\todo{do we need to include how many peers discovered as well?}
exclude webseed and httpseed.
compared 
